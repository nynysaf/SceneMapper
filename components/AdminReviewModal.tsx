...
const AdminReviewModal: React.FC<AdminReviewModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-emerald-950/40 backdrop-blur-md">
      <div className="glass w-full max-w-2xl rounded-[2.5rem] solarpunk-shadow overflow-hidden flex flex-col animate-in fade-in zoom-in duration-300 max-h-[85vh]">
